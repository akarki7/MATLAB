...
% they are the axes of a surface/mesh object (in the middle of the object)
%if false it means they are axis of the joint

if (nargin < 3)%if we data of visual object is passed then set it to false
    frame_B_is_visual_object= false;
end
if (nargin < 4)%if axis length parameter is not passed
    axis_length= 0.5;
end
